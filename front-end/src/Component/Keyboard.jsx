...
function Keyboard(){
    ...
    return (
        ...
        <section>
            <input className="TextBox" type='text' onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} placeholder='Click Here to Start Typing'></input>
        </section>
        <section className="Keyboard">
            <section className="row">
                ...
                <p className={`keys ${pressedKey === '-' ? `active` : ``}`}>-</p>
                <p className={`keys ${pressedKey === '=' ? `active` : ``}`}>=</p>
                <p className={`Backspace ${pressedKey === 'backspace' ? `active` : ``}`}>Backspace</p>
            </section>
            <section className="row">
            ...
            <section className="row">
                <p className={`Caps_Lock ${pressedKey === 'capslock' ? `active` : ``}`}>Caps Lock</p>
                ...
                <p className={`keys ${pressedKey === ';' ? `active` : ``}`}>;</p>
                <p className={`keys ${pressedKey === "'" ? `active` : ``}`}>'</p>
                <p className={`Enter_Key ${pressedKey === 'enter' ? `active` : ``}`}>Enter</p>
            </section>
            <section className="row">
                <p className={`Shift_Left ${pressedKey === "shift" ? `active` : ``}`}>Shift</p>
                ...
                <p className={`keys ${pressedKey === "/" ? `active` : ``}`}>/</p>
                <p className={`keys ${pressedKey === "?" ? `active` : ``}`}>?</p>
                <p className={`Shift_Right ${pressedKey === "shift" ? `active` : ``}`}>Shift</p>
            </section>
            <section className="row">   
                <p className={`Ctrl ${pressedKey === "control" ? `active` : ``}`}>Ctrl</p>
                <p className={`Alt ${pressedKey === "alt" ? `active` : ``}`}>Alt</p>
                <p className={`Space_Key ${pressedKey === " " ? `active` : ``}`}>____</p>
                <p className={`Ctrl ${pressedKey === "alt" ? `active` : ``}`}>Alt</p>
                <p className={`Alt ${pressedKey === "control" ? `active` : ``}`}>Ctrl</p>
            </section>
        </section>
        </div>
